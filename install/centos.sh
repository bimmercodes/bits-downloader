...
# BITS Downloader - CentOS Installation Script
...
echo "==================================="
echo "BITS Downloader - CentOS Install"
echo "==================================="
echo
...
# Enable EPEL repository (required for transmission)
echo "[1/4] Enabling EPEL repository..."
