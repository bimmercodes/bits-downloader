# 📂 BITS-DOWNLOADER Project Structure
...
│   ├── bits-downloader.sh           # Main TUI application (entry point)
│   ├── start_torrents.sh            # Start the torrent manager daemon
│   ├── stop_torrents.sh             # Stop the torrent manager daemon
│   ├── monitor_torrents.sh          # Real-time torrent monitor
│   └── torrent_control.sh           # Interactive control panel
│
├── 📁 lib/                          # Library/Helper Scripts
│   ├── torrent_manager.sh           # Core torrent management daemon
│   └── install_torrents_manager.sh  # Legacy installer
│
├── 📁 ui/                           # User Interface Scripts
│   ├── terminal_dashboard.sh        # Full-screen responsive dashboard
│   └── demo_responsive.sh           # Animated demo showcase
│
├── 📁 docs/                         # Documentation
│   ├── README.md                    # Legacy documentation
│   ├── CHANGELOG.md                 # Version history
│   ├── QUICKSTART.md                # Quick start guide
│   └── torrent_guide.md             # Torrent usage guide
│
├── 📁 data/                         # Data Files
│   ├── torrent_list.txt             # Queue of torrents to download
│   └── torrent_list.txt.example     # Example torrent list
│
├── 📁 downloads/                    # Downloaded Files (user data)
...
│   ├── torrent_manager.log          # Main manager log
│   ├── transmission.log             # Transmission daemon log
│   ├── completed.log                # Completed downloads log
│   ├── current_status.txt           # Current status snapshot
│   ├── nohup.log                    # Background process log
│   └── .gitkeep                     # Keep directory in git
│
├── 📄 bits                          # Quick launcher (./bits)
...
└── 📄 .installed                    # Installation marker (generated)
```
...
bits-downloader.sh checks .installed
    ↓
If not installed → Run installation wizard
    ↓
If installed → Show main menu
    ↓
User selects "Start Torrent Manager"
    ↓
start_torrents.sh launches → lib/torrent_manager.sh
    ↓
...
Downloads to downloads/.incomplete/
    ↓
On completion → Moves to downloads/
    ↓
